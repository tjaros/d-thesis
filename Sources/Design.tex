...
\begin{enumerate}
    ...
    \item \textbf{Cryptographic Properties} They are recorded only for the TPM devices. They are split into multiple data sets, and each data set contains only specific information about the tested TPM. Most notable are execution time duration information for cryptographic algorithms and generated RSA or ECC key pairs. 
\end{enumerate}

...
As can be seen from \myref{Figure}{fig:device_profile_classes}, the profile classes are very similar. They all have to store specific results and other information inherited from their abstract base class. The results are dictionaries where we associate the identification of a result with its object or a list of these objects for easier checking if a specific result was measured.

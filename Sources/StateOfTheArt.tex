...
\end{tabular}
    \end{adjustbox}
    \caption{Use of TPM 2.0 cryptographic algorithms in discussed schemes. The \cmark symbol signifies that the algorithm was used in this scheme, whereas - symbol means that this algorithm was not used.}
    \label{table:schemes}
\end{table}

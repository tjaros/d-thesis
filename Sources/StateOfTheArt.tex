...
The most notable software solution used for disk encryption that supports TPM 2.0 directly is Bitlocker, a disk encryption software developed by Microsoft. It uses the TPM to store encryption keys, though the TPM is not necessary~\cite{bitlockerMDocs}.
